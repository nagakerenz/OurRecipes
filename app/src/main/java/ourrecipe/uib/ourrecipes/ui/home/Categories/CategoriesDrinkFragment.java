...
public class CategoriesDrinkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.d_fragment_categories_drink, container, false);
        ...
        recipesRef = FirebaseDatabase.getInstance().getReference().child("Food Recipes").child("Drink");
